...
public class FissionFuel {
    ...
    public static HashMap<List<String>, DeferredItem<Item>> NC_FUEL = new HashMap<>();
    public static HashMap<List<String>, DeferredItem<Item>> NC_DEPLETED_FUEL = new HashMap<>();
    public static HashMap<String, DeferredItem<Item>> NC_ISOTOPES = new HashMap<>();
    ...
    public static DeferredItem<Item> fuel(String name, String type, String subType) {
        return ITEMS.register("fuel_" + name + "_" + type.replace("-", "_") + subType,
                () -> new ItemFuel(ITEM_PROPERTIES, name, type, subType));
    }

    public static DeferredItem<Item> depletedFuel(String name, String type, String subType) {
