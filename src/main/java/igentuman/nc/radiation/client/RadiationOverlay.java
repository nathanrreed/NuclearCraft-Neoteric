...
public class RadiationOverlay {
    ...
    private static final ResourceLocation RADIATION_BAR_TEXTURE = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/overlay/radiation_bar.png");
    ...
    public static final LayeredDraw.Layer RADIATION_BAR = (gui, deltaTracker) -> {
        ...
        gui.blit(RADIATION_BAR_TEXTURE, 4, y - 15, 0, 0, 94, 11, 256, 256);
        int maxRadiationBar = PlayerRadiation.maxPlayerRadiation;
        int barWidth = (int) Math.min(128, radiation * 90 / maxRadiationBar);
        RenderSystem.setShaderTexture(0, RADIATION_BAR_TEXTURE);
        gui.blit(RADIATION_BAR_TEXTURE, 6, y - 13, 0, 11, barWidth, 8, 256, 256);
    };
}