...
//            case SINGLE -> from(FluidStack.STREAM_CODEC.decode(new RegistryFriendlyByteBuf(buffer)));
...
//            ITagManager<Fluid> tagManager = TagUtil.manager(BuiltInRegistries.FLUID);
